...
import kotlinx.android.synthetic.main.activity_internet.btn_assistant
import kotlinx.android.synthetic.main.activity_internet.btn_chrome
import kotlinx.android.synthetic.main.activity_internet.btn_gmail
import kotlinx.android.synthetic.main.activity_internet.btn_map
import kotlinx.android.synthetic.main.activity_internet.img_wave
import kotlinx.android.synthetic.main.activity_internet.img_wave2
import kotlinx.android.synthetic.main.activity_internet.textTv
import java.util.*
...
class Internet : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_assistant.setOnClickListener {
            googleAssistant()
        }

        btn_chrome.setOnClickListener {
            chrome()
        }
        ...
        when (requestCode) {
            ...
            Request_code_speech_input -> {
                ...
                if (resultCode == Activity.RESULT_OK && data != null) {
                    ...
                    if(textTv.text == "quran" || textTv.text == "quraan" ||
