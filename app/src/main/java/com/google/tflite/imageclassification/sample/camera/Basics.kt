...
import kotlinx.android.synthetic.main.activity_basics.btn_date
import kotlinx.android.synthetic.main.activity_basics.btn_time
import kotlinx.android.synthetic.main.activity_basics.img_wave
import kotlinx.android.synthetic.main.activity_basics.img_wave2
import kotlinx.android.synthetic.main.activity_basics.textTv
...
class Basics : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_talkb.setOnClickListener {

            speak()
        }

        btn_cameras.setOnClickListener {
            opCamera()
        }

        btn_tensor.setOnClickListener {
            tensor()
        }
            ...
            Request_code_speech_input -> {
                ...
                if (resultCode == Activity.RESULT_OK && data != null) {
                    ...
                    if(textTv.text == "quran" || textTv.text == "quraan" ||
                        ...
                        date()
                    } else if (textTv.text == "map" || textTv.text == "Map" ||
                            textTv.text == "Maps" || textTv.text == "maps") {
                        map()
